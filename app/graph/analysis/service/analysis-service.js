...
define([
    'connecta.graph',
    'graph/analysis/controller/_analysis-database',
    'graph/analysis/controller/_analysis-endeca',
    'graph/analysis/controller/_analysis-sorl',
    'graph/analysis/controller/_analysis-webservice',
    'graph/analysis/controller/_analysis-csv',
    'graph/analysis/controller/_analysis-obiee',
    'graph/analysis/controller/_analysis-hdfs',
    'graph/analysis/controller/_analysis-rest'
], function (graph,
    ...
    return graph.lazy.service('AnalysisService', function (graphResources, $http, DomainService) {
        ...
        var _types = {
            ...
            ENDECA: {
                ...
                start: function (idDatasouce, component) {
                    var url = graphResources.analysis + "/" + idDatasouce + "/domains-endeca";
            ...
            BI: {
                ...
                start: function (idDatasouce, component) {
                    var url = graphResources.analysis + "/" + idDatasouce + "/catalog-obiee";
            ...
            WEBSERVICE: {
                ...
                start: function (datasouce, component) {
                    ...
                    if (datasouce.typeWebservice === "REST") {
                        url = graphResources.analysis + "/" + datasouce.id + "/get-rest-specifications";
                        $http.get(url).then(function (response) {
                    ...
                    if (datasouce.typeWebservice === "SOAP") {
                        ...
                        url = graphResources.analysis + "/" + datasouce.id + "/method-soap";
                        $http.get(url).then(function (response) {
            ...
            REST: {
                ...
                start: function (datasouce, component) {
                    var url = graphResources.datasource + '/' + datasouce.id + "/rest";
                     $http.get(url).then(function(response){
        ...
        this.list = function (params) {
            var url = graphResources.analysis;
            return $http.get(url, {
                params: params
            });
        };
        ...
        this.remove = function (id) {
            var url = graphResources.analysis + '/' + id;
        ...
        this.getListTableDatasource = function (idDataSource) {
            var url = graphResources.analysis + "/" + idDataSource + "/columns-datasource";
            return $http.get(url);
        };
        ...
        this.execute = function (analysisExecuteRequest) {
            var url = graphResources.analysis + "/result";
        ...
        this.possibleValuesFor = function (analysisExecuteRequest, filter) {
            var url = graphResources.analysis + "/filter-value?column=" +
        ...
        this.getAnalysis = function (idAnalysis) {
            var url = graphResources.analysis + "/" + idAnalysis;
            return $http.get(url);
        };
        
        this.getAnalysisRest = function (idAnalysis) {
            var url = graphResources.analysis + "/" + idAnalysis +"/rest";
            return $http.get(url);
        };
        ...
        this.getListColumnsObiee = function (idDatasouce, path) {
            var url = graphResources.analysis + "/" + idDatasouce + "/columns-obiee";
            return $http.post(url, {'path': path});
        };

        //lista Columns endeca
        this.getListColumnsEndeca = function (idDatasouce, domain) {
            var url = graphResources.analysis + "/" + idDatasouce + "/columns-endeca/" + domain;
            return $http.get(url);
        };
        ...
        this.getSoap = function (idDatasouce, operation, parametersWebservice) {
            ...
            var url = graphResources.analysis + "/" + idDatasouce + "/soap/operation/" + operation;
        ...
        this.getResulApplyingXpath = function (analysis, operation) {
            var analysisCopy = angular.copy(analysis);
            var url = graphResources.analysis + "/" + analysis.datasource.id + "/soap-applying-xpath/operation/" + operation;
            return $http.post(url, analysisCopy);
        };
        ...
        this.getResulApplyingJson = function (idDatasouce, analysis) {
            ...
            var url = graphResources.analysis + "/" + idDatasouce + "/rest-get-applying-jsonPath";
            return $http.post(url, analysisCopy);
        };
        ...
        this.getSolrResultApplyingQuery = function (idDatasouce, query, facet) {
            ...
            var url = graphResources.analysis + "/" + idDatasouce + "/solr-result-applying-query/facet/" + facet;
            return $http.post(url, queryPersist);
        };

        this.saveQueryBuilder = function (query) {
            var queryBuilder = angular.copy({"statement": query});
            var urlSaveQuery = graphResources.group + "/query";
        ...
        this.getConditionsSorl = function (id) {
            var url = graphResources.analysis + "/" + id + "/conditions-sorl";
            return $http.get(url);
        };
        ...
        this.getResultCSV = function (analysis) {
            var analysisCopy = angular.copy(analysis);
            var url = graphResources.analysis + "/result-csv";
            return $http.post(url, analysisCopy);
        };
        
        this.sendRequest = function (analysis) {
            var analysisCopy = angular.copy(analysis);
           var url = graphResources.analysis + '/execute-rest';
            return $http.post(url, analysisCopy);
        };
        ...
        this.getTabularFormatJson = function ( analysis) {
            var analysisCopy = angular.copy(analysis);
            console.log("analysis ", analysisCopy);
            var url = graphResources.analysis + "/rest-tabular-format";
            return $http.post(url, analysisCopy);
        };
        ...
        this.bulkRemove = function (analysisList) {
            return $http.delete(graphResources.analysis, {
        ...
        this.createSocket = function(){
            return new SockJS(graphResources.webSocket);
        };

        this.createPublicSocket = function(){
            return new SockJS(graphResources.publicWebSocket);
        };
    });
});
