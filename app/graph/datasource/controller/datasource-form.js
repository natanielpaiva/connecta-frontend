define([
    ...
    'graph/datasource/controller/modal-rest-response',
], function (graph) {
    return graph.lazy.controller('DatasourceFormController', function ($scope, $window, DatasourceService, $location, $routeParams, util, notify, $uibModal) {
            ...
            rest: {
                ...
                sendRequest: function (request) {
                    DatasourceService.sendRequest(request).then(function (response) {
                        $uibModal.open({
                            animation: true,
                            templateUrl: 'app/graph/datasource/template/_modal-rest-response.html',
        ...
        $scope.submit = function () {
            DatasourceService.save($scope.datasource).then(function (response) {
                $location.path('graph/datasource/' + response.data.id);
            });
        };
