...
define([
    ...
    inspection._menu = [
        ...
        },
        {
            ...
            children: [
                {
                    href:'inspection/inspection/scheduling',
                    title:'INSPECTION.SCHEDULING'
                },
                {
                    href:'inspection/inspection/costs',
                    title:'INSPECTION.COSTS'
                },
                {
                    href:'inspection/inspection/requisiton',
                    title:'INSPECTION.REQUISITION'
                },
                {
        ...
        },
        {
            ...
            children: [
                {
                    href:'inspection/diligence/scheduling',
                    title:'INSPECTION.SCHEDULING'
                },
                {
                    href:'inspection/diligence/costs',
                    title:'INSPECTION.COSTS'
                },
                {
                    href:'inspection/diligence/requistion',
                    title:'INSPECTION.REQUISITION'
                },
                {
                    href:'inspection/diligence',
                    icon: 'icon-settings',
                    title:'INSPECTION.DILIGENCES'
                }
            ]
